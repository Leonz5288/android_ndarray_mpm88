...
{ // range for
  ...
  for (int _sid = _sid0; _sid < (_end - _beg); _sid += int(gl_WorkGroupSize.x * gl_NumWorkGroups.x)) {
    int _itv = _beg + _sid;
      ...
      int CDY = 0;
      int CFP = int(0);
      int CE0 = CDY + 229416 * CFP; // S0
      int CE1 = CE0 + 65576; // S9
      int CFn = int(4095);
      int CFo = K & CFn;
      int CE4 = CE1 + 8 * CFo; // S9
      int CE5 = CE4 + 0; // S10
      _data_f32_[CE5 >> 2] = As;
      int CEf = CE4 + 4; // S11
      _data_f32_[CEf >> 2] = Aw;
      float AC = float(0.0);
      int CEl = CE0 + 98344; // S12
      int CEo = CEl + 8 * CFo; // S12
      int CEp = CEo + 0; // S13
      _data_f32_[CEp >> 2] = AC;
      float AF = float(-1.0);
      int CEz = CEo + 4; // S14
      _data_f32_[CEz >> 2] = AF;
      float AI = float(1.0);
      int CEF = CE0 + 32808; // S20
      int CEI = CEF + 4 * CFo; // S20
      int CEJ = CEI + 0; // S21
      _data_f32_[CEJ >> 2] = AI;
      float AL = float(6.1035156e-05);
      int CEP = CE0 + 40; // S5
      int CES = CEP + 4 * CFo; // S5
      int CET = CES + 0; // S6
      _data_f32_[CET >> 2] = AL;
      int CEZ = CE0 + 16424; // S7
      int CF2 = CEZ + 4 * CFo; // S7
      int CF3 = CF2 + 0; // S8
      _data_f32_[CF3 >> 2] = AL;
  }
}
